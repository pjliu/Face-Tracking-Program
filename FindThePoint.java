...
*/            
            ...
            for (int i=0; i<imgDim.height; i++)
            {
                for (int j=0; j<imgDim.width; j++)
                {
                    ...
                    else if (r >= brightest.getRed() &&
                             g >= brightest.getGreen() &&
                             b >= brightest.getBlue())
                    {
                        brightest = currColor;
                        brightestX = j;
...
*/
            ...
            System.out.println("The dot is at the point: {"+(brightestX+1)+","+(brightestY+1)+"} "+ "with a color of " + brightest);
