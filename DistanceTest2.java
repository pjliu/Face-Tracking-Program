...
public class DistanceTest2
{
    public static void main(String[] args) throws IOException 
    {
        ...
        String datFile = "G:\\Documents\\Pictures\\CamTestPics2\\15.txt";
...
*/                  
            ...
            System.out.println("distance between midpoint0 and midpoint1="+calcDist(midpoints[0], midpoints[1]));
            System.out.println("distance between midpoint0 and midpoint2="+calcDist(midpoints[0], midpoints[2]));
            System.out.println("distance between midpoint1 and midpoint2="+calcDist(midpoints[1], midpoints[2])); 
            System.out.println("real distance is approximately=" +runt2(midpoints[0].y, midpoints[1].y, midpoints[2].y));
/*            
